...
class EventController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.index')->with([
            'title',
            'Se ha agendado de forma correcta.',
            'info',
            'Recuerda que no puedes faltar a tu clase, si faltas a las clases sin justificación se cobran 20 mil pesos por hora no vista.',
            'icono',
            'success'
        ]);
    }
