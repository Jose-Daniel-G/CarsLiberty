    ...
    <div class="relative flex h-16 items-center justify-between">
      ...
      <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        ...
        <a href="/" class="flex flex-shrink-0 items-center">
               <img src="{{ asset('vendor/adminlte/dist/img/libertad.png') }}" alt="Logo" class="w-10 h-10"> {{-- <img class="h-8 w-auto" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=500" alt="Your Company"> --}}
        </a>
      ...
      @else
      <div>
          <a href="{{ route('clogin') }}" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Ingresar</a>
          <a href="{{ route('cregister') }}" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Registrarse</a>
      </div>
      @endauth
